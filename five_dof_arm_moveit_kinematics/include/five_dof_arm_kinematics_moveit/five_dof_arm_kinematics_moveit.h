#ifndef FIVE_DOF_ARM_KINEMATICS_MOVEIT_H
#define FIVE_DOF_ARM_KINEMATICS_MOVEIT_H
...
#include <five_dof_arm_kinematics_moveit/kinematics_logger.h>


namespace five_dof_arm_kinematics_moveit
{
...
class KinematicsPlugin : public kinematics::KinematicsBase
{
    ...
    private:
         ...
         */
        boost::shared_ptr<five_dof_arm_kinematics::InverseKinematics> ik_;
