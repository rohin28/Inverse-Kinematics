#include <five_dof_arm_kinematics_moveit/five_dof_arm_kinematics_moveit.h>
#include <five_dof_arm_kinematics_moveit/configuration_comparator.h>
...
PLUGINLIB_EXPORT_CLASS(five_dof_arm_kinematics_moveit::KinematicsPlugin,
        kinematics::KinematicsBase);


using namespace five_dof_arm_kinematics_moveit;
        ...
        double search_discretization)
{
    ...
    ik_.reset(new five_dof_arm_kinematics::InverseKinematics(lower_limits,
