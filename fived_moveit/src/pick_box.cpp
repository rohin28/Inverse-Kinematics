...
typedef actionlib::SimpleActionClient<moveit_msgs::PickupAction> PickUp_Client;
...
int main(int argc, char **argv)
{
  ...
  PickUp_Client pickup_client("pickup",true) ;
  ...
  pickup_goal.group_name = "five_dof_arm" ; // Name of group for pickup
  pickup_goal.end_effector = "end_effector" ;// Name of eef for pickup
  ...
  g.pre_grasp_approach.direction.vector.z = -1.0;
  g.pre_grasp_approach.direction.header.frame_id = "pre_grasp_approach";
  g.pre_grasp_approach.min_distance = 0.1;
  g.pre_grasp_approach.desired_distance = 0.2;

  g.post_grasp_retreat.direction.header.frame_id = "post_grasp_retreat";
  g.post_grasp_retreat.direction.vector.z = 1.0;
  g.post_grasp_retreat.min_distance = 0.1;
  g.post_grasp_retreat.desired_distance = 0.2;
